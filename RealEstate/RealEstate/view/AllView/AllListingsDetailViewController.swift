//
//  AllListingsDetailViewController.swift
//  RealEstate
//
...
class AllListingsDetailViewController: UIViewController {
    ...
    private lazy var textView: UITextView = {
        ...
        textView.font = UIFont.systemFont(ofSize: 18) // Увеличиваем размер шрифта
        return textView
    }()
